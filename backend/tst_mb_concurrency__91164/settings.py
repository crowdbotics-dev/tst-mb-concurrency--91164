"""
Django settings for tst_mb_concurrency__91164 project.
...
ROOT_URLCONF = 'tst_mb_concurrency__91164.urls'
...
WSGI_APPLICATION = 'tst_mb_concurrency__91164.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "tst_mb_concurrency__91164 API",
    "DESCRIPTION": "API documentation for tst_mb_concurrency__91164 App",
    "VERSION": "v1",
}
