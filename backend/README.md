...
## Project Structure
    ...
    ├── tst_mb_concurrency__91164  # Django project configurations
...
1. Clone this repo and `cd tst_mb_concurrency__91164`
...
2. Clone this repo and `cd tst_mb_concurrency__91164`
